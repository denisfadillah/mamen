            ...
            <div class="col-md-8">
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    ...
                    <form role="form" id="addBlog" action="<?php echo base_url() ?>addNewBlog" method="post" role="form">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">                                
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="statusLabel" placeholder="Status" name="status" maxlength="10">
                                    </div>
                                </div>    
                            </div>							
                        </div><!-- /.box-body -->
