...
class Blog_model extends CI_Model
{
    ...
    function blogListingCount($searchText = '')
    {
        ...
        if(!empty($searchText)) {
            $likeCriteria = "(tbl_post.title  LIKE '%".$searchText."%'
                            OR  tbl_post.content  LIKE '%".$searchText."%'
                            OR  tbl_post.tags  LIKE '%".$searchText."%')";
    ...
    {
        $this->db->trans_start();
        $this->db->insert('tbl_post', $blogInfo);
    ...
    {
        $this->db->where('id', $id);
        $this->db->update('tbl_post', $blogInfo);
